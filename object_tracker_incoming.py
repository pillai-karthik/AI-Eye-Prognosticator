...
#
        cv2.line(img, (0, int(3*height/6+height/20)), (width, int(3*height/6+height/20)), (255, 0, 0), thickness=2)
        cv2.line(img, (0, int(3*height/6-height/20)), (width, int(3*height/6-height/20)), (255, 0, 0), thickness=2)

        cv2.line(img, (0, int(4*height/6+height/20)), (width, int(4*height/6+height/20)), (255, 0, 0), thickness=2)
        cv2.line(img, (0, int(4*height/6-height/20)), (width, int(4*height/6-height/20)), (255, 0, 0), thickness=2)
